...
inline reg128_float fma_float_128(reg128_float a, reg128_float b, reg128_float acc) { return _mm_fmadd_ps(a, b, acc); }
...
// ============================================================================
// Pack from scalars — construct a register from individual values
// WARNING: arguments are in NATURAL order (lane0 first, unlike _mm_set_ps)
// ============================================================================

// -- 128-bit --
// 4 floats → reg128_float  [a, b, c, d]
inline reg128_float pack_float_128(float lane0, float lane1, float lane2, float lane3) {
    return _mm_setr_ps(lane0, lane1, lane2, lane3);
}

// 2 doubles → reg128_double  [a, b]
inline reg128_double pack_double_128(double lane0, double lane1) { return _mm_setr_pd(lane0, lane1); }

// -- 256-bit --
// 8 floats → reg256_float  [a, b, c, d, e, f, g, h]
...
// 4 doubles → reg256_double  [a, b, c, d]
inline reg256_double pack_double_256(double lane0, double lane1, double lane2, double lane3) {
    return _mm256_setr_pd(lane0, lane1, lane2, lane3);
}
