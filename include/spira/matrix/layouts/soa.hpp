...
class soa {
    public:
        struct iterator {
            ...
            iterator& operator++()    noexcept { ++col_ptr; ++val_ptr; return *this; }
            iterator  operator++(int) noexcept { auto t = *this; ++(*this); return t; }
            iterator& operator--()    noexcept { --col_ptr; --val_ptr; return *this; }
            iterator  operator--(int) noexcept { auto t = *this; --(*this); return t; }

            iterator& operator+=(difference_type n) noexcept { col_ptr += n; val_ptr += n; return *this; }
            iterator& operator-=(difference_type n) noexcept { col_ptr -= n; val_ptr -= n; return *this; }
        ...
        struct const_iterator {
            ...
            const_iterator& operator++()    noexcept { ++col_ptr; ++val_ptr; return *this; }
            const_iterator operator++(int) noexcept { auto t = *this; ++(*this); return t; }
            const_iterator& operator--()    noexcept { --col_ptr; --val_ptr; return *this; }
            const_iterator operator--(int) noexcept { auto t = *this; --(*this); return t; }

            const_iterator& operator+=(difference_type n) noexcept { col_ptr += n; val_ptr += n; return *this; }
            const_iterator& operator-=(difference_type n) noexcept { col_ptr -= n; val_ptr -= n; return *this; }
            friend const_iterator operator+(const_iterator it, difference_type n) noexcept { it += n; return it; }
            friend const_iterator operator+(difference_type n, const_iterator it) noexcept { it += n; return it; }
            friend const_iterator operator-(const_iterator it, difference_type n) noexcept { it -= n; return it; }
        ...
        void clear() noexcept { columns.clear(); values.clear(); }
        void reserve(std::size_t n) { columns.reserve(n); values.reserve(n); }
