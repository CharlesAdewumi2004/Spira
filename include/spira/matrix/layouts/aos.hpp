...
class aos {
    public:
        ...
        struct const_iterator {
            ...
            constexpr const_iterator  operator++(int) noexcept { auto t = *this; ++(*this); return t; }
            constexpr const_iterator& operator--()    noexcept { --ptr; return *this; }
            constexpr const_iterator  operator--(int) noexcept { auto t = *this; --(*this); return t; }

            constexpr const_iterator& operator+=(difference_type n) noexcept { ptr += n; return *this; }
            constexpr const_iterator& operator-=(difference_type n) noexcept { ptr -= n; return *this; }
            friend constexpr const_iterator operator+(const_iterator it, difference_type n) noexcept { it += n; return it; }
            friend constexpr const_iterator operator+(difference_type n, const_iterator it) noexcept { it += n; return it; }
            friend constexpr const_iterator operator-(const_iterator it, difference_type n) noexcept { it -= n; return it; }
